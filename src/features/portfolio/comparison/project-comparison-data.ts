...
export const COMPARISON_SPECS: Record<string, ProjectArchitectureSpec> = {
  ...
  lyrune: {
    ...
    latencyBudget: "< 16ms frame budget (60 FPS target) & < 50ms timestamp sync",
  ...
  "kerala-flood-risk-platform": {
    ...
    stateStrategy: "Local Parquet telemetry lakehouse + BigQuery cloud blueprint",
    failureMode: "Synthetic historical fallback data generator for reproducible tests",
    concurrencyModel: "Multi-threaded pandas batch execution; GPU cuDF & PySpark tested as exploratory benchmark variants",
    primaryTradeoff: {
